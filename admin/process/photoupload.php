...
$query="INSERT INTO `images` (image, frontimage, image_text) VALUES ('$target_file', '$front_file', '$caption')";
...
header("location: ../pages/index.php?page=manage_gallery&message=upload_success");
}
